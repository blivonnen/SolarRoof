...
# COPY roof-segmentation-control-net/data/train-00000-of-00001.parquet /workspace/roof-segmentation-control-net/data/train-00000-of-00001.parquet
...
# ovhai job run --name solar-roof-job --flavor ai1-le-1-gpu -v blivonnen-s3@my-os:/workspace:rw blivonnen/solar-roof:latest -- bash -c 'python3 /workspace/SolarRoof/main.py --epochs 1'